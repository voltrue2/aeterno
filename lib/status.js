...
Status.prototype.outputStatus = function (data, processes) {
	...
	print.out(' Application started at			: ' +  started);
	if (data.msg.reloadedCount) {
		print.out(' Application reloaded at		: ' + reloaded);
	}
	print.out(' Application running hours since start:	: ' + sinceStart + ' hours');
	if (data.msg.reloadedCount) {
		print.out(' Application running hours since reload	: ' + sinceReload + ' hours');
	}
